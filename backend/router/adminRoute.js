...
import {
  ...
  viewAdminProfile,
  viewAllDistricts,
  viewAllPagePanchayath,
  viewAllPageUsers,
  viewAllPageZonal,
  viewAllPanchayaths,
  viewAllUsers,
  viewAllZonals,
  viewNotTakenDistricts,
  viewNotTakenZonals,
  viewParamsDistricts,
  viewParamsPanchayaths,
  viewParamsZonals,
  viewStates,
  viewUserDetails,
  viewWithdrawPendingPaginated,
...
import {
  addPoolPercentage,
  distributeAutoPoolWallet,
} from "../controller/incomeGereratorController.js";
...
adminRouter.post(
  "/process-wallet-withdrawal/:id",
  protectAdmin,
  processWalletWithdrawal
);
adminRouter.post(
  "/process-demat-account/:id",
  protectAdmin,
  processDematAccount
);
...
adminRouter.post("/approve-renewal/:id", protectAdmin, acceptRenewalRequest);

//reject renewal request
adminRouter.post("/reject-renewal/:id", protectAdmin, rejectRenewalRequest);
...
adminRouter.get("/view-dashboard-data", protectAdmin, dashboardDatas);
...
adminRouter.post("/view-filtered-users", protectAdmin, filteredUsers);

adminRouter.post("/view-filtered-demates", protectAdmin, filteredDemates);
