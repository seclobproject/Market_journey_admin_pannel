...
<div className="container-fluid">
      <div class="row mt-2">
                <div class="col-md-3 mb-2">
                  <div class="card " style={{ background: "#00335B" ,height:'100%'}}>
  ...
  <div class="card" style={{ background: "#00335B", height: '100%' }}>
    ...
    <h5
      ...
      <div className="col">
        <input type="number" className="form-control mb-2" placeholder="%"  style={{ background: "#ffff" }}/>
      </div>
      <div className="col">
        <input type="number" className="form-control mb-2" placeholder="%" style={{ background: "#ffff" }} />
      </div>
              ...
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                <thead className="text-dark fs-4 table-light">
                  <tr>
                    ...
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Amount Credited </h6>
                    </th>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Percentage Credited</h6>
                    </th>
