...
import { uploadvideoUrl, viewvideouploadUrl } from '../../../utils/Constants';
  ...
  const handleCancelName = () => {
   ...
   const addVideoFun = async (e) => {
    try {
      ...
      formdata.append("thambnail", addVideo, addVideo?.name);
      formdata.append("videoLink", details?.videoLink);
      formdata.append("videoTitle",  details?.videoTitle);

      const response = await ApiCall("post", uploadvideoUrl, formdata);
